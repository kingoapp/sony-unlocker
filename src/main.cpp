...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationDomain(settings.value("Update/Pid", "com.kingoapp.unlocker.sony").toString());
    QCoreApplication::setApplicationName("Sony One-Click Unlocker");
